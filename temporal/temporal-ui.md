...
Hint: The buttons in Temporal UI are mirrors of that is in `tctl` and the docs
are usually there

The UI only allows me to reset to "Workflow Task Completed" points in history Is
that just a limitation of the UI or more fundamental? Can I reset to any point
using the CLI?
